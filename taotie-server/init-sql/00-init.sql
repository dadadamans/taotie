...
-- 2. 创建业务数据库
-- =============================================
CREATE DATABASE IF NOT EXISTS sky_take_out CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE sky_take_out;

-- TODO: ⚠️ 请将你的 sky_take_out 建表 SQL 粘贴到这里
-- 可以从本地数据库导出: mysqldump -u root -p --no-data sky_take_out > schema.sql
-- 然后复制 CREATE TABLE 语句到此处
